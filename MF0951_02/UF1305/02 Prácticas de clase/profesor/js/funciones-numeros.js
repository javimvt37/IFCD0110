...
document.getElementById("demo3").innerHTML='<p>La función de Número () convierte el argumento objeto a un número que representa el valor del objeto.</p> <p>Si el valor no se puede convertir en un número legal, se devuelve NaN.</p><p><b>Nota</b>: Si el parámetro es un objeto Date, la función Number () devuelve el número de milisegundos desde la medianoche del 1 de enero de, 1970 UTC.</p>';

	document.getElementById("demo4").innerHTML = 'Para la variable <code>true</code> Number() devuelve '+Number(x1)+'<br>'+
												'Para la variable <code>false</code> Number() devuelve '+Number(x2)+'<br>'+
												'Para la variable <code>new Date()</code> Number() devuelve '+Number(x3)+'<br>'+
												'Para la variable <code>999</code> Number() devuelve '+Number(x4)+'<br>'+
												'Para la variable <code>999 888</code> Number() devuelve '+Number(x1)+'<br>';
...
function parsearNumero(){
  ...
  var n = a + b + c + d + e + f + g;
	...
	document.getElementById("demo3").innerHTML='<p>La función parseFloat () analiza una cadena y devuelve un número de coma flotante.</p><p>Esta función determina si el primer carácter de la cadena especificada es un número. Si lo es, se analiza la cadena hasta que llega al final de la serie, y devuelve el número como un número, no como una cadena.</p><p><b>Nota</b>: Sólo se devuelve el primer número de la cadena!</p><p><b>Nota</b>: se permiten espacios iniciales y finales.</p><p><b>Nota</b>: Si el primer carácter no puede ser convertido a un número, parseFloat () devuelve NaN.</p>';

	document.getElementById("demo4").innerHTML = 'Para la variable <code>"10"</code> parseFloat() devuelve '+a+'<br>'+
												'Para la variable <code>"10.00"</code> parseFloat() devuelve '+b+'<br>'+
												'Para la variable <code>"10.33")</code> parseFloat() devuelve '+c+'<br>'+
												'Para la variable <code>"34 45 66"</code> parseFloat() devuelve '+d+'<br>'+
												'Para la variable <code>"   60   "</code> parseFloat() devuelve '+e+'<br>'+
												'Para la variable <code>"40 years"</code> parseFloat() devuelve '+f+'<br>';
...
function convertirEntero(){
  ...
  document.getElementById("demo3").innerHTML='<p>La función parseInt () analiza una cadena y devuelve un entero.</p><p>El parámetro radix se utiliza para especificar qué sistema de numeración a ser utilizado, por ejemplo, un radix de 16 (hexadecimal) indica que el número en la cadena debe ser analizada de un número hexadecimal a un número decimal.</p>';

	document.getElementById("demo4").innerHTML = 'Para la variable <code>"10"</code> parseInt() devuelve '+a+'<br>'+
												'Para la variable <code>"10.00"</code> parseInt() devuelve '+b+'<br>'+
												'Para la variable <code>"10.33")</code> parseInt() devuelve '+c+'<br>'+
												'Para la variable <code>"34 45 66"</code> parseInt() devuelve '+d+'<br>'+
												'Para la variable <code>"   60   "</code> parseInt() devuelve '+e+'<br>'+
												'Para la variable <code>"40 years"</code> parseInt() devuelve '+f+'<br>'+
												'Para la variable <code>"He was 40"</code> parseInt() devuelve '+g+'<br>'+
												'Para la variable <code>""</code> parseInt() devuelve '+h+'<br>;
